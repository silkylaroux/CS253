...
string string_from_num(long input){ 
    ...
    if(input >= -8 && input < 8){ 
        ...
        buffer<<'5' << setfill('0')<< setw(11) << hex << (input & 0xffffffffff) << dec;
cout << input << " " << buffer.str();
    ...
    }else if( input <= (-9223372036854775807-1)){
//cout << input <<" ";
        buffer<<'8' << setfill('f')<< setw(17) << hex << (input & 0xffffffffffffffff) << dec;
//cout << buffer.str() << '\n';
    } else {
        buffer<<'8' << setfill('0')<< setw(17) << hex << (input & 0xffffffffffffffff) << dec;
//cout << buffer.str() << '\n';
    }
//1222333444555
